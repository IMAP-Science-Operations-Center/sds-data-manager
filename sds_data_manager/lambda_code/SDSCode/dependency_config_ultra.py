...
downstream_dependents = [
    ...
    PreProcessingDependency(
        ...
        dependent_instrument="ultra",
        dependent_data_level="l1b",
        dependent_descriptor="45annotated-events",
        relationship="HARD",
        direction="DOWNSTREAM",
    ),
    PreProcessingDependency(
    ...
    PreProcessingDependency(
        ...
        dependent_instrument="ultra",
        dependent_data_level="l1b",
        dependent_descriptor="90annotated-events",
        relationship="HARD",
        direction="DOWNSTREAM",
    ),
]
...
upstream_dependents = [
    ...
    PreProcessingDependency(
        primary_instrument="ultra",
        primary_data_level="l1b",
        primary_descriptor="45annotated-events",
        dependent_instrument="ultra",
        dependent_data_level="l1a",
    ...
    PreProcessingDependency(
        primary_instrument="ultra",
        primary_data_level="l1b",
        primary_descriptor="90annotated-events",
        dependent_instrument="ultra",
        dependent_data_level="l1a",
