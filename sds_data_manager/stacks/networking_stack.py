...
class NetworkingStack(Stack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.batch_security_group = ec2.SecurityGroup(self, "FargateInstanceSecurityGroup",
                                                vpc=self.vpc)

        self.rds_security_group.add_ingress_rule(self.batch_security_group, ec2.Port.tcp(5432),
